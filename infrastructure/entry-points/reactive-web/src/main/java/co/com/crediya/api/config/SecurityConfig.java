    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.POST, "/api/v1/solicitud").hasAnyRole("cliente", "administrador")
                        .pathMatchers(HttpMethod.GET, "/api/v1/solicitud").hasAnyRole("asesor", "administrador")
                        .pathMatchers(HttpMethod.PUT, "/api/v1/solicitud").hasAnyRole("asesor")
                        .pathMatchers(HttpMethod.GET, "/api/v1/solicitud/user/{idUser}").hasAnyRole("servicios")
    ...
    public ServerAuthenticationEntryPoint customAuthenticationEntryPoint() {
        return (exchange, ex) -> {
            ...
            try {
                ...
                String fallbackBody = "{\"codigo\":\"UNAUTHORIZED\",\"mensaje\":\"Token inválido o no proporcionado\",\"status\":401}";
    ...
    public ServerAccessDeniedHandler customAccessDeniedHandler() {
        return (exchange, denied) -> {
            ...
            try {
                ...
                String fallbackBody = "{\"codigo\":\"FORBIDDEN\",\"mensaje\":\"Sin permisos suficientes\",\"status\":403}";
                org.springframework.core.io.buffer.DataBuffer buffer = exchange.getResponse().bufferFactory().wrap(fallbackBody.getBytes());
                return exchange.getResponse().writeWith(Mono.just(buffer));
            }
        };
    }
