...
@Tag(
    name = "Solicitudes",
    description = "Operaciones relacionadas con la gestión de solicitudes de crédito")
    ...
    @RouterOperation(
        ...
        operation =
            @Operation(
                ...
                description =
                    "Crea una nueva solicitud de crédito con validación de cliente y préstamo. Valida que el cliente exista y que el tipo de préstamo sea válido antes de crear la solicitud.",
                tags = {"Solicitudes"},
                ...
                requestBody =
                    @RequestBody(
                        ...
                        content =
                            @Content(schema = @Schema(implementation = CrearSolicitudDTO.class))),
                responses = {
                  @ApiResponse(
                      responseCode = "201",
                      description = "Solicitud creada exitosamente",
                      content =
                          @Content(schema = @Schema(implementation = RespuestaSolicitudDTO.class))),
                  @ApiResponse(
                      responseCode = "400",
                  ...
                  @ApiResponse(
                      responseCode = "422",
                      description = "Tipo de préstamo inválido",
                      content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                  @ApiResponse(
                      responseCode = "500",
    ...
    @RouterOperation(
        ...
        operation =
            @Operation(
                ...
                description =
                    "Obtiene una lista completa de todas las solicitudes de crédito asociadas a un usuario específico identificado por su ID. No aplica paginación.",
                tags = {"Solicitudes"},
                security = @SecurityRequirement(name = "bearerAuth"),
                parameters = {@Parameter(name = "idUser", in = ParameterIn.PATH, required = true)},
                responses = {
                  @ApiResponse(
                      responseCode = "200",
                      ...
                      content =
                          @Content(
                              schema =
                                  @Schema(
                                      type = "array",
                                      implementation = RespuestaSolicitudDTO.class))),
                  @ApiResponse(
                      responseCode = "400",
    ...
    @RouterOperation(
        ...
        operation =
            @Operation(
                ...
                description =
                    "Obtiene una lista paginada de solicitudes de crédito del usuario autenticado. Permite navegar a través de múltiples páginas de resultados.",
                tags = {"Solicitudes"},
                security = @SecurityRequirement(name = "bearerAuth"),
                parameters = {
                  @Parameter(
                ...
                responses = {
                  @ApiResponse(
                      ...
                      description = "Solicitudes obtenidas exitosamente",
                      content =
                          @Content(schema = @Schema(implementation = PaginatedResponseDTO.class))),
                  @ApiResponse(
                      responseCode = "400",
    ...
    @RouterOperation(
        ...
        operation =
            @Operation(
                ...
                description =
                    "Actualiza el estado de una solicitud de crédito existente. Envía una notificación SQS cuando se actualiza el estado.",
                tags = {"Solicitudes"},
                security = @SecurityRequirement(name = "bearerAuth"),
                requestBody =
                    @RequestBody(
                        ...
                        content =
                            @Content(
                                schema = @Schema(implementation = ActualizarSolicitudDTO.class))),
                responses = {
                  @ApiResponse(
                      responseCode = "200",
