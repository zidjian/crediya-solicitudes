...
class TipoPrestamoUseCaseTest {
  ...
  @InjectMocks private TipoPrestamoUseCase tipoPrestamoUseCase;
  ...
  void findById_CuandoTipoPrestamoExiste_DebeRetornarTipoPrestamo() {
    // Arrange
    when(tipoPrestamoRepository.findById(validIdTipoPrestamo))
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof NotFoundException
                    && throwable
                        .getMessage()
                        .equals("No existe un tipo de préstamo con id: " + validIdTipoPrestamo))
        .verify();
  }
            ...
            throwable ->
                throwable instanceof RuntimeException
                    && throwable
                        .getMessage()
                        .equals(
                            "Error al buscar el tipo de préstamo con id: " + validIdTipoPrestamo)
