...
public class Solicitud {
  ...
  public static Solicitud toSolicitud(
      String idUser,
      String email,
      BigDecimal monto,
      LocalDate plazo,
  ...
  public static Solicitud fromDatabase(
      Long idSolicitud,
      String idUser,
      String email,
      BigDecimal monto,
  ...
  /**
   * Calcula la cuota mensual (deuda total mensual) usando la fórmula de anualidad financiera: PMT =
   * P * [r (1 + r)^n] / [(1 + r)^n - 1] donde: P = monto del préstamo r = tasa de interés mensual
   * (tasa anual / 12 / 100) n = número de meses entre la fecha actual y la fecha de plazo
   *
   * <p>Casos especiales: - Si n <= 0, se considera n = 1 para evitar divisiones por cero. - Si r =
   * 0 (tasa de interés anual = 0), la cuota es P / n.
   *
