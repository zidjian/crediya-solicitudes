...
class PageResultTest {
  ...
  void isLast_deberiaSerTrue_cuandoPaginaEsIgualATotalPagesMenosUno() {
    ...
    PageResult<Integer> pageResult =
        new PageResult<>(
            content, 2, 2, 5); // page 2, size 2, total 5 -> totalPages = 3, so page 2 is last
  ...
  void isLast_deberiaSerFalse_cuandoPaginaEsMenorQueTotalPagesMenosUno() {
    ...
    PageResult<Integer> pageResult =
        new PageResult<>(
            content, 0, 2, 6); // page 0, size 2, total 6 -> totalPages = 3, so page 0 is not last
