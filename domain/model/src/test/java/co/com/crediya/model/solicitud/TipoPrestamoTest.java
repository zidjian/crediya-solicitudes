...
class TipoPrestamoTest {
    ...
    void toTipoPrestamo_ConDatosValidos_DebeCrearTipoPrestamoExitosamente() {
        ...
        // Act
        TipoPrestamo tipoPrestamo = TipoPrestamo.toTipoPrestamo(
    ...
    void constructor_CuandoMontoMinimoEsNulo_DebeLanzarIllegalArgumentException() {
        ...
        IllegalArgumentException exception = assertThrows(
            ...
            () -> TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimoNulo, montoMaximo, tasaInteres, true)
        );
    ...
    @DisplayName("constructor - Debe lanzar IllegalArgumentException cuando montoMinimo es menor o igual a cero")
    void constructor_CuandoMontoMinimoEsMenorOIgualACero_DebeLanzarIllegalArgumentException(String montoStr) {
        // Arrange
    ...
    void constructor_CuandoMontoMaximoEsNulo_DebeLanzarIllegalArgumentException() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimo, montoMaximoNulo, tasaInteres, true)
        );
    ...
    @Test
    @DisplayName("constructor - Debe lanzar IllegalArgumentException cuando montoMaximo es menor al mínimo")
    ...
    void constructor_CuandoMontoMaximoEsIgualAlMinimo_DebeCrearTipoPrestamoExitosamente() {
        ...
        // Act
        TipoPrestamo tipoPrestamo = TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimo, montoMaximo, tasaInteres, true);
    ...
    void constructor_CuandoTasaInteresEsNula_DebeLanzarIllegalArgumentException() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimo, montoMaximo, tasaInteresNula, true)
        );
    ...
    void constructor_CuandoTasaInteresEsNegativa_DebeLanzarIllegalArgumentException() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimo, montoMaximo, tasaInteresNegativa, true)
        );
    ...
    void constructor_CuandoTasaInteresEsCero_DebeCrearTipoPrestamoExitosamente() {
        ...
        // Act
        TipoPrestamo tipoPrestamo = TipoPrestamo.toTipoPrestamo(1L, "Préstamo", montoMinimo, montoMaximo, tasaInteresCero, true);
    ...
    void validarMonto_ConMontoEnRango_DebeRetornarTrue() {
        // Arrange
        TipoPrestamo tipoPrestamo = TipoPrestamo.toTipoPrestamo(
            1L, "Préstamo Personal", BigDecimal.valueOf(1000), BigDecimal.valueOf(50000), BigDecimal.valueOf(0.15), true
        );
